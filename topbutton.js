...
$.topbutton = function(op){
    ...
    var html = '<button type="button" id="topButton" style="'+scrollAndShow+'position:fixed; border:none; outline:none; overflow:hidden; cursor:pointer; '+attr+'">'+_op.htlm+'</button>';
    $('body').append(html);
